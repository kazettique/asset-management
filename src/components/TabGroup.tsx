...
export default function TabGroup(props: Props) {
  ...
  return (
    ...
    >
      <button
        data-is-active={true}
        className="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 data-[is-active='true']:bg-gray-100 sm:text-sm data-[is-active='true']:dark:bg-gray-800 dark:text-gray-300"
      >
        All
      </button>
