    ...
    <div className="flex justify-center items-center min-h-screen">
      {isOpen && (
        <div>
                  ...
                  <div className="mt-4 px-4 h-full overflow-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 1</h3>
                        <p className="text-gray-600">Content for card 1.</p>
                      </div>
                      {/* Card 2 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 2</h3>
                      ...
                      {/* Card 5 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 5</h3>
                        <p className="text-gray-600">Content for card 5.</p>
                      </div>
                      {/* Card 6 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 6</h3>
                        <p className="text-gray-600">Content for card 6.</p>
                      </div>
                      {/* Card 7 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 7</h3>
                        <p className="text-gray-600">Content for card 7.</p>
                      </div>
                      {/* Card 8 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 8</h3>
                        <p className="text-gray-600">Content for card 8.</p>
                      </div>
                      {/* Card 9 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 9</h3>
                        <p className="text-gray-600">Content for card 9.</p>
                      </div>
                      {/* Card 10 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 10</h3>
                        <p className="text-gray-600">Content for card 10.</p>
                      </div>
                      {/* Card 11 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 11</h3>
                        <p className="text-gray-600">Content for card 11.</p>
                      </div>
                      {/* Card 12 */}
                      <div className="bg-gray-50 hover:bg-gray-100 p-4 cursor-pointer rounded-md border border-gray-300 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-black mb-2">Card 12</h3>
          ...
          {/* Open sidebar button */}
          <button onClick={() => setIsOpen(true)} className="px-4 py-2 bg-black text-white rounded-md">
            {' '}
            Open Sidebar{' '}
          </button>
        </div>
